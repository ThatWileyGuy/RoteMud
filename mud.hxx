...
#define CHANGEHTML_FILE                                                                                                \
    "../../public_html/changes.html"      /*                                                                           \
Changes file - html    */
#define DEBUG_FILE SYSTEM_DIR "debug.txt" /* Catch-all for debug */
#define TYPO_FILE SYSTEM_DIR "typos.txt"  /* For 'typo'		 */
#define LOG_FILE SYSTEM_DIR "log.txt"     /* For talking in logged rooms */
#define WIZLIST_FILE SYSTEM_DIR "WIZLIST" /* Wizlist		 */
#define WEBWIZLIST_FILE                                                                                                \
    "../../public_html/WEBWIZLIST" /* Web                                                                              \
Wizlist	 */
#define WHO_FILE                                                                                                       \
    SYSTEM_DIR "../html/WHO" /* Who                                                                                    \
output file      */
#define WEBWHO_FILE                                                                                                    \
    "../../public_html/WEBWHO"                 /* Web Who File                                                         \
                                                */
