        ...
        if (!char_died(ch))
        {
            ...
            if (ch->mental_state >= 30)
                ...
                case 9:
                    ...
                    act(AT_ACTION, "$n is ranting on about 'the answer', 'ONE' and other mumbo-jumbo...", ch, NULL,
                        NULL, TO_ROOM);
                    break;
                case 10:
...
void auction_update(void)
{
    ...
    case 3: /* SOLD! */
        ...
        else /* not sold */
        {
            ...
            talk_auction(buf);
            act(AT_ACTION, "&wA courier arrives, and returns $p to you.", auction->seller, auction->item, NULL,
                TO_CHAR);
