...
const RACE_TYPE race_table[MAX_RACE] = {
    ...
    {"Firrerreo", AFF_AQUA_BREATH, +1, -2, 0, 0, +2, +3, 0, 0, +40, +1000, RIS_FIRE, 0, 0,
     LANG_FIRRERREO}, /*-dip/lead, +1500 mana, no force levels, leave on so that if a forcer does come they have large*/
    ...
    {"Togorian", AFF_DETECT_HIDDEN | AFF_SNEAK, +4, +4, 0, 0, -2, -11, 0, 0, +40, 0, 0, 0, 0,
     LANG_TOGORIAN},                                                                   //++cmbt,+bh
    ...
    {"Coynite", AFF_SNEAK, +4, +2, +1, 0, +1, -3, 0, 0, +30, 0, 0, 0, 0,
     LANG_COYNITE}, //++combat/lead, +bh, -piloting/dip
    ...
    {"Intera Droid", AFF_AQUA_BREATH + AFF_FLYING + AFF_FLOATING, 0, +4, -9, +5, +1, -5, 0, 0, 0, 0, 0, 0,
     LANG_BINARY} //(+)lead
};
...
const STR_APP_TYPE str_app[26] = {
    ...
    {-3, -2, 3, 2},  {-3, -1, 10, 3},                                                      /* 3  */
    {-2, -1, 25, 4}, {-2, -1, 55, 5},                                                      /* 5  */
    {-1, 0, 80, 6},  {-1, 0, 90, 8},  {0, 0, 100, 10}, {0, 0, 100, 12},  {0, 0, 115, 14},  /* 10  */
    {0, 0, 115, 15}, {0, 0, 140, 16}, {0, 0, 140, 17},                                     /* 13  */
    {0, 1, 170, 18}, {1, 1, 170, 19},                                                      /* 15  */
    {1, 2, 195, 20}, {2, 3, 220, 22}, {2, 4, 250, 25},                                     /* 18  */
