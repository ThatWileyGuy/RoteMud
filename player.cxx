...
char* drawlife(int min, int max) {
	...
	if (per < 0) per = 0;
	if (per > 100) per = 100;
	if (per == 100)  sprintf_s(buf, "&G&W[&R|||||&Y||||&G||||&W]");
	else if (per >= 90 && per < 100) sprintf_s(buf, "&G&W[&R|||||&Y||||&G|||&G-&W]");
	else if (per >= 80 && per < 90)  sprintf_s(buf, "&G&W[&R|||||&Y||||&G||&G--&W]");
	else if (per >= 70 && per < 80)  sprintf_s(buf, "&G&W[&R|||||&Y||||&G|&G---&W]");
	else if (per >= 60 && per < 70)  sprintf_s(buf, "&G&W[&R|||||&Y|||&G&G-----&W]");
	else if (per >= 50 && per < 60)  sprintf_s(buf, "&G&W[&R|||||&Y||&G&G------&W]");
	else if (per >= 40 && per < 50)  sprintf_s(buf, "&G&W[&R|||||&Y|&G&G-------&W]");
	else if (per >= 30 && per < 40)  sprintf_s(buf, "&G&W[&R|||||&Y&G&G--------&W]");
	else if (per >= 30 && per < 40)  sprintf_s(buf, "&G&W[&R||||&Y&G&G---------&W]");
	else if (per >= 20 && per < 40)  sprintf_s(buf, "&G&W[&R|||&Y&G&G----------&W]");
	else if (per >= 10 && per < 40)  sprintf_s(buf, "&G&W[&R||&Y&G&G-----------&W]");
	else if (per >= 0 && per < 10)  sprintf_s(buf, "&G&W[&R&Y&G&G-------------&W]");
	//else sprintf_s(buf, "&G&W[&R&W]");
	return buf;
}
...
char* drawmove(int min, int max) {
	...
	else if (per >= 30 && per < 40)  sprintf_s(buf, "&G&W[&R|&G&Y&G------&W]");
	else if (per >= 20 && per < 40)  sprintf_s(buf, "&G&W[&R|&G&Y&G------&W]");
	else if (per >= 10 && per < 40)  sprintf_s(buf, "&G&W[&R|&G&Y&G------&W]");
	else if (per >= 0 && per < 10)  sprintf_s(buf, "&G&W[&R&G&Y&G-------&W]");
	else sprintf_s(buf, "&G&W[&R&W]");
	return buf;
}
...
char* drawalign(int align) {
	static char buf[MAX_STRING_LENGTH];
	if (align >= 100) sprintf_s(buf, "&W[&C============&W|&W]");
	else if (align >= 90 && align < 100) sprintf_s(buf, "&W[&C===========&W|&C=&W]");
	else if (align >= 60 && align < 90) sprintf_s(buf, "&W[&C==========&W|&C==&W]");
	else if (align >= 40 && align < 60) sprintf_s(buf, "&W[&C=========&W|&C===&W]");
	else if (align >= 20 && align < 40) sprintf_s(buf, "&W[&C========&W|&C====&W]");
	else if (align >= 10 && align < 20) sprintf_s(buf, "&W[&C=======&W|&C=====&W]");
	else if (align >= 0 && align < 10) sprintf_s(buf, "&W[&C======&W|&C======&W]");
	else if (align <= -1 && align > -20) sprintf_s(buf, "&W[&C=====&W|&C=======&W]");
	else if (align <= -20 && align > -40) sprintf_s(buf, "&W[&C====&W|&C========&W]");
	else if (align <= -60 && align > -80) sprintf_s(buf, "&W[&C===&W|&C=========&W]");
	else if (align <= -80 && align > -100) sprintf_s(buf, "&W[&C==&W|&C==========&W]");
	else if (align <= -100) sprintf_s(buf, "&W[&W|&C============&W]");
 ...
 */
 ...
 void do_score(CHAR_DATA * ch, char *argument)
 {
	 ...
	 {
	 case POS_DEAD:
		 sprintf_s(buf, "You are slowly decomposing. ");
		 break;
	 case POS_MORTAL:
		 sprintf_s(buf, "You are mortally wounded. ");
		 break;
	 case POS_INCAP:
		 sprintf_s(buf, "You are incapacitated. ");
		 break;
	 case POS_STUNNED:
		 sprintf_s(buf, "You are stunned. ");
		 break;
	 case POS_SLEEPING:
		 sprintf_s(buf, "You are sleeping. ");
		 break;
	 case POS_RESTING:
		 sprintf_s(buf, "You are resting. ");
		 break;
	 case POS_STANDING:
		 sprintf_s(buf, "You are standing. ");
		 break;
	 case POS_FIGHTING:
		 sprintf_s(buf, "You are fighting. " );
		 break;
	 case POS_MOUNTED:
		 sprintf_s(buf, "You are mounted. ");
		 break;
		 case POS_SITTING:
		 sprintf_s(buf, "You are sitting. ");
		 break;
	 }
			...
			if (obj->wear_loc == iWear)
			{
				...
				if (can_see_obj(ch, obj))
				{
					...
					case ITEM_ARMOR:
						...
						if (dam >= 10) strcat_s(buf, " (superb) ");
						else if (dam >= 7) strcat_s(buf, " (good) ");
						else if (dam >= 5) strcat_s(buf, " (worn) ");
						else if (dam >= 3) strcat_s(buf, " (poor) ");
						else if (dam >= 1) strcat_s(buf, " (awful) ");
					...
					case ITEM_WEAPON:
						...
						if (dam < 2) strcat_s(buf, " (superb) ");
						else if (dam < 4) strcat_s(buf, " (good) ");
						else if (dam < 7) strcat_s(buf, " (worn) ");
						else if (dam < 10) strcat_s(buf, " (poor) ");
						else if (dam < 12) strcat_s(buf, " (awful) ");
...
void do_report(CHAR_DATA* ch, char* argument)
{
	...
	ch_printf(ch, "%sYou report: %d/%d hp %d/%d mv.\n\r",
		color_str(AT_REPORT, ch), ch->hit, ch->max_hit,
		ch->move, ch->max_move);


	sprintf_s(buf, "$n reports: %d/%d hp %d/%d.",
		ch->hit, ch->max_hit,
		ch->move, ch->max_move);
