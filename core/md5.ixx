...
export void md5_init(md5_state_t* pms)
{
...
export void md5_append(md5_state_t* pms, const md5_byte_t* data, int nbytes)
{
...
export void md5_finish(md5_state_t* pms, md5_byte_t digest[16])
{
