...
export FORCE_SKILL* get_force_skill(const char* argument);
FORCE_HELP* get_force_help(const char* fname, const char* type);
export void force_send_to_room(CHAR_DATA* ch, CHAR_DATA* victim, char* msg);
export CHAR_DATA* force_get_victim(CHAR_DATA* ch, char* argument, int loc);
...
export const char* force_parse_string(CHAR_DATA* ch, CHAR_DATA* victim, const char* msg);
export void force_learn_from_failure(CHAR_DATA* ch, FORCE_SKILL* fskill);
export void force_learn_from_success(CHAR_DATA* ch, FORCE_SKILL* fskill);
export FORCE_SKILL* force_test_skill_use(const char* skill_name, CHAR_DATA* ch, int skill_type);
const char* force_get_level(CHAR_DATA* ch);
export int force_promote_ready(CHAR_DATA* ch);
export void draw_force_line(CHAR_DATA* ch, int length);
export void update_force(void);

export FORCE_SKILL* first_force_skill;
export FORCE_SKILL* last_force_skill;

export FORCE_HELP* first_force_help;
export FORCE_HELP* last_force_help;
...
export void force_send_to_room(CHAR_DATA* ch, CHAR_DATA* victim, const char* msg)
{
    CHAR_DATA* dch;
...
export void draw_force_line_rev(CHAR_DATA* ch, int length)
{
    int x;
