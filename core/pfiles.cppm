...
tm* new_pfile_time;
tm new_pfile_struct;
export time_t new_pfile_time_t;
...
export void init_pfile_scan_time(void)
{
    /*
...
export void check_pfiles(time_t reset)
{
    /*
...
export void add_member(char* name, char* shortname)
{
...
export void remove_member(char* name, char* shortname)
{
    FILE* fpList;
    FILE* fpNew;
    const char* buf;
