...
/*
   ...
   -- Xorith
*/
export char* strrep(const char* src, const char* sch, const char* rep)
{
...
export char* strlinwrp(char* src, int length)
{
...
export std::string remand(const std::string_view& arg)
{
    std::string result;
...
export char* rembg(const char* src)
{
