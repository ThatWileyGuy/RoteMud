...
void do_mpstat(CHAR_DATA* ch, char* argument)
{
    ...
    ch_printf(ch, "Lv: %d.  Align: %d.  AC: %d.  Credits: %d.\n\r", victim->top_level, victim->alignment,
...
void do_mptransfer(CHAR_DATA* ch, char* argument)
{
    ...
    if (!str_cmp(arg1, "all"))
    {
        for (victim = ch->in_room->first_person; victim; victim = nextinroom)
        {
            ...
            {
                sprintf_s(buf, "%s %s", victim->name, arg2);
...
void do_mp_close_passage(CHAR_DATA* ch, char* argument)
{
    ...
    /* act( AT_PLAIN, "A passage closes!", ch, nullptr, nullptr, TO_CHAR ); */
    /* act( AT_PLAIN, "A passage closes!", ch, nullptr, nullptr, TO_ROOM ); */
...
void do_mpapplyb(CHAR_DATA* ch, char* argument)
{
    ...
    case 2:
        send_to_char("Your name has been deemed unsuitable by the gods.  Please choose a more apropriate name with the "
                     "'name' command.\n\r",
                     victim);
        add_timer(victim, TIMER_APPLIED, 10, nullptr, 0);
        break;
