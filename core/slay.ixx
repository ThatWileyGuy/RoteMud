...
void do_slay(CHAR_DATA* ch, char* argument)
{
    ...
    if (!found)
        send_to_char("&RSlay type not defined, or not owned by you. Type \"slay list\" for a complete listing of types "
                     "available to you.\n\r",
                     ch);
