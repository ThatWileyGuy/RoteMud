...
export SPELL_FUN* spell_function(char* name)
{
...
export DO_FUN* skill_function(char* name)
{
 ...
 */
export void save_skill_table(int delnum)
{
    int x;
    FILE* fpout;
...
export int get_skill(char* skilltype)
{
...
export void write_last_file(char* entry)
{
    FILE* fpout;
    FILE* fptemp;
...
export void read_last_file(CHAR_DATA* ch, int count, char* name)
{
    FILE* fpout;
    char filename[MAX_INPUT_LENGTH];
    char charname[100];
