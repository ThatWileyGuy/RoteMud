...
void do_marry(CHAR_DATA* ch, char* argument)
{
    ...
    */
    sprintf_s(buf, "&R(&WMarriage&R} &W%s: I am very pleased to announce that %s and %s are now married.", ch->name,
              vic1->name, vic2->name);
...
void do_divorce(CHAR_DATA* ch, char* argument)
{
    ...
    vic1->gold -= 500;
    vic2->gold -= 500;
    sprintf_s(buf, "&R(&WMarriage&R} &W%s: It is my sad duty to anounce that %s and %s are now divorced.", ch->name,
              vic1->name, vic2->name);
}
