...
export ROOM_INDEX_DATA* cur_room;
export bool cur_char_died;
export ch_ret global_retcode;

export int cur_obj;
export int cur_obj_serial;
export bool cur_obj_extracted;
export obj_ret global_objcode;
...
export void explode(OBJ_DATA* obj)
{
    if (obj->armed_by)
    {
 ...
 */
export int get_exp_worth(CHAR_DATA* ch)
{
    int exp;
 ...
 */
export int exp_level(sh_int level)
{
    int lvl;
 ...
 */
export sh_int get_trust(CHAR_DATA* ch)
{
    if (!ch)
        return 0;
 ...
 */
export sh_int get_age(CHAR_DATA* ch)
{
 ...
 */
export sh_int get_curr_str(CHAR_DATA* ch)
{
 ...
 */
export sh_int get_curr_int(CHAR_DATA* ch)
{
 ...
 */
export sh_int get_curr_wis(CHAR_DATA* ch)
{
 ...
 */
export sh_int get_curr_dex(CHAR_DATA* ch)
{
 ...
 */
export sh_int get_curr_con(CHAR_DATA* ch)
{
 ...
 */
export sh_int get_curr_cha(CHAR_DATA* ch)
{
 ...
 */
export sh_int get_curr_lck(CHAR_DATA* ch)
{
    return URANGE(3, ch->perm_lck + ch->mod_lck, 25);
}

/* Not changed for obvious reasons */
export sh_int get_curr_frc(CHAR_DATA* ch)
{
    sh_int max;
 ...
 */
export int can_carry_n(CHAR_DATA* ch)
{
    int penalty = 0;
 ...
 * Retrieve a character's carry capacity.
 */
export int can_carry_w(CHAR_DATA* ch)
{
    if (!IS_NPC(ch) && get_trust(ch) >= LEVEL_IMMORTAL)
        return 1000000;
 ...
 */
export bool can_take_proto(CHAR_DATA* ch)
{
    if (IS_IMMORTAL(ch))
        return true;
 ...
 */
export bool is_name(const char* str, const char* namelist)
{
 ...
 */
export bool nifty_is_name(const char* str, const char* namelist)
{
    char name[MAX_INPUT_LENGTH];
...
export bool nifty_is_name_prefix(const char* str, const char* namelist)
{
    char name[MAX_INPUT_LENGTH];
 ...
 */
export void affect_modify(CHAR_DATA* ch, AFFECT_DATA* paf, bool fAdd)
{
    OBJ_DATA* wield;
    int mod;
    SKILL_TYPE* skill;
 ...
 */
export void affect_to_char(CHAR_DATA* ch, AFFECT_DATA* paf)
{
    AFFECT_DATA* paf_new;
 ...
 */
export void affect_remove(CHAR_DATA* ch, AFFECT_DATA* paf)
{
    if (!ch->first_affect)
    {
 ...
 */
export void affect_strip(CHAR_DATA* ch, int sn)
{
    AFFECT_DATA* paf;
 ...
 */
export bool is_affected(CHAR_DATA* ch, int sn)
{
    AFFECT_DATA* paf;
 ...
 * they're there :)
 */
export void affect_join(CHAR_DATA* ch, AFFECT_DATA* paf)
{
    AFFECT_DATA* paf_old;
 ...
 */
export void char_from_room(CHAR_DATA* ch)
{
    OBJ_DATA* obj;
 ...
 */
export void char_to_room(CHAR_DATA* ch, ROOM_INDEX_DATA* pRoomIndex)
{
    OBJ_DATA* obj;
 ...
 */
export OBJ_DATA* obj_to_char(OBJ_DATA* obj, CHAR_DATA* ch)
{
    OBJ_DATA* otmp;
    OBJ_DATA* oret = obj;
 ...
 */
export void obj_from_char(OBJ_DATA* obj)
{
    CHAR_DATA* ch;
 ...
 */
export int apply_ac(OBJ_DATA* obj, int iWear)
{
 ...
 */
export OBJ_DATA* get_eq_char(CHAR_DATA* ch, int iWear)
{
 ...
 */
export void equip_char(CHAR_DATA* ch, OBJ_DATA* obj, int iWear)
{
    AFFECT_DATA* paf;
    OBJ_DATA* otmp;
 ...
 */
export void unequip_char(CHAR_DATA* ch, OBJ_DATA* obj)
{
    AFFECT_DATA* paf;
 ...
 */
export void obj_from_room(OBJ_DATA* obj)
{
 ...
 */
export OBJ_DATA* obj_to_room(OBJ_DATA* obj, ROOM_INDEX_DATA* pRoomIndex)
{
    OBJ_DATA *otmp, *oret;
 ...
 */
export OBJ_DATA* obj_to_obj(OBJ_DATA* obj, OBJ_DATA* obj_to)
{
    OBJ_DATA *otmp, *oret;
 ...
 */
export void obj_from_obj(OBJ_DATA* obj)
{
    OBJ_DATA* obj_from;
 ...
 */
export void extract_obj(OBJ_DATA* obj)
{
 ...
 */
export void extract_char(CHAR_DATA* ch, bool fPull)
{
    CHAR_DATA* wch;
    OBJ_DATA* obj;
    char buf[MAX_STRING_LENGTH];
 ...
 */
export CHAR_DATA* get_char_room(CHAR_DATA* ch, const char* argument)
{
 ...
 */
export CHAR_DATA* get_char_world(CHAR_DATA* ch, const char* argument)
{
    char arg[MAX_INPUT_LENGTH];
    CHAR_DATA* wch;
    int number, count, vnum;
...
export CHAR_DATA* get_char_world_ooc(CHAR_DATA* ch, const char* argument)
{
    char arg[MAX_INPUT_LENGTH];
    CHAR_DATA* wch;
    int number, count, vnum;
...
export CHAR_DATA* get_char_from_comfreq(CHAR_DATA* ch, const char* argument)
{
    CHAR_DATA* wch;
 ...
 */
export OBJ_DATA* get_obj_list(CHAR_DATA* ch, const char* argument, OBJ_DATA* list)
{
    char arg[MAX_INPUT_LENGTH];
    OBJ_DATA* obj;
    int number;
 ...
 */
export OBJ_DATA* get_obj_list_rev(CHAR_DATA* ch, const char* argument, OBJ_DATA* list)
{
    char arg[MAX_INPUT_LENGTH];
    OBJ_DATA* obj;
    int number;
 ...
 */
export OBJ_DATA* get_obj_carry(CHAR_DATA* ch, const char* argument)
{
    char arg[MAX_INPUT_LENGTH];
    OBJ_DATA* obj;
    int number, count, vnum;
 ...
 */
export OBJ_DATA* get_obj_wear(CHAR_DATA* ch, const char* argument)
{
    char arg[MAX_INPUT_LENGTH];
    OBJ_DATA* obj;
    int number, count, vnum;
 ...
 */
export OBJ_DATA* get_obj_here(CHAR_DATA* ch, const char* argument)
{
    OBJ_DATA* obj;
 ...
 */
export OBJ_DATA* get_obj_world(CHAR_DATA* ch, const char* argument)
{
    char arg[MAX_INPUT_LENGTH];
    OBJ_DATA* obj;
    int number, count, vnum;
 ...
 */
export bool ms_find_obj(CHAR_DATA* ch)
{
 ...
 */
export OBJ_DATA* find_obj(CHAR_DATA* ch, char* argument, bool carryonly)
{
...
export int get_obj_number(OBJ_DATA* obj)
{
    return obj->count;
}
 ...
 */
export int get_obj_weight(OBJ_DATA* obj)
{
    int weight;
 ...
 */
export bool room_is_dark(ROOM_INDEX_DATA* pRoomIndex)
{
    if (!pRoomIndex)
    {
 ...
 */
export bool room_is_private(CHAR_DATA* ch, ROOM_INDEX_DATA* pRoomIndex)
{
    CHAR_DATA* rch;
    int count;
 ...
 */
export bool can_see(CHAR_DATA* ch, CHAR_DATA* victim)
{
    if (!victim)
        return false;
 ...
 */
export bool can_see_obj(CHAR_DATA* ch, OBJ_DATA* obj)
{
    if (!IS_NPC(ch) && IS_SET(ch->act, PLR_HOLYLIGHT))
        return true;
 ...
 */
export bool can_drop_obj(CHAR_DATA* ch, OBJ_DATA* obj)
{
 ...
 */
export std::string item_type_name(OBJ_DATA* obj)
{
 ...
 */
export std::string affect_loc_name(int location)
{
    switch (location)
    {
    case APPLY_NONE:
 ...
 */
export std::string affect_bit_name(int vector)
{
    std::string result;
 ...
 */
export std::string extra_bit_name(int extra_flags)
{
    std::string result;
 ...
 */
export std::string magic_bit_name(int magic_flags)
{
    std::string result;
 ...
 */
export ch_ret spring_trap(CHAR_DATA* ch, OBJ_DATA* obj)
{
    int dam;
    int typ;
    int lev;
 ...
 */
export ch_ret check_for_trap(CHAR_DATA* ch, OBJ_DATA* obj, int flag)
{
    OBJ_DATA* check;
    ch_ret retcode;
 ...
 */
export ch_ret check_room_for_traps(CHAR_DATA* ch, int flag)
{
    OBJ_DATA* check;
    ch_ret retcode;
 ...
 */
export bool is_trapped(OBJ_DATA* obj)
{
    OBJ_DATA* check;
 ...
 */
export OBJ_DATA* get_trap(OBJ_DATA* obj)
{
    OBJ_DATA* check;
 ...
 */
export void extract_exit(ROOM_INDEX_DATA* room, EXIT_DATA* pexit)
{
 ...
 */
export void clean_room(ROOM_INDEX_DATA* room)
{
 ...
 */
export void clean_obj(OBJ_INDEX_DATA* obj)
{
    AFFECT_DATA* paf;
    AFFECT_DATA* paf_next;
    EXTRA_DESCR_DATA* ed;
 ...
 */
export void clean_mob(MOB_INDEX_DATA* mob)
{
    MPROG_DATA *mprog, *mprog_next;
...
/* no more silliness */
export void name_stamp_stats(CHAR_DATA* ch)
{
 ...
 */
export void fix_char(CHAR_DATA* ch)
{
    AFFECT_DATA* aff;
 ...
 */
export void showaffect(CHAR_DATA* ch, AFFECT_DATA* paf)
{
    char buf[MAX_STRING_LENGTH];
    int x;
 ...
 */
export void set_cur_obj(OBJ_DATA* obj)
{
    cur_obj = obj->serial;
 ...
 */
export bool obj_extracted(OBJ_DATA* obj)
{
    OBJ_DATA* cod;
 ...
 */
export void set_cur_char(CHAR_DATA* ch)
{
    cur_char = ch;
    cur_char_died = false;
    cur_room = ch->in_room;
 ...
 */
export bool char_died(CHAR_DATA* ch)
{
 ...
 */
export void add_timer(CHAR_DATA* ch, sh_int type, sh_int count, DO_FUN* fun, int value)
{
    TIMER* timer;
...
export TIMER* get_timerptr(CHAR_DATA* ch, sh_int type)
{
    TIMER* timer;
...
export sh_int get_timer(CHAR_DATA* ch, sh_int type)
{
    TIMER* timer;
...
export void extract_timer(CHAR_DATA* ch, TIMER* timer)
{
    if (!timer)
    {
...
export void remove_timer(CHAR_DATA* ch, sh_int type)
{
    TIMER* timer;
...
export bool in_hard_range(CHAR_DATA* ch, AREA_DATA* tarea)
{
    if (IS_IMMORTAL(ch))
        return true;
    else if (IS_NPC(ch))
 ...
 */
export bool chance(CHAR_DATA* ch, sh_int percent)
{
 ...
 */
export OBJ_DATA* clone_object(OBJ_DATA* obj)
{
    OBJ_DATA* clone;
 ...
 */
export void split_obj(OBJ_DATA* obj, int num)
{
    int count;
    OBJ_DATA* rest;
...
export void separate_obj(OBJ_DATA* obj)
{
    split_obj(obj, 1);
}
 ...
 */
export bool empty_obj(OBJ_DATA* obj, OBJ_DATA* destobj, ROOM_INDEX_DATA* destroom)
{
 ...
 */
export void better_mental_state(CHAR_DATA* ch, int mod)
{
 ...
 */
export void worsen_mental_state(CHAR_DATA* ch, int mod)
{
    int c = URANGE(0, abs(mod), 20);
    int con = get_curr_con(ch);
 ...
 */
export void boost_economy(AREA_DATA* tarea, int gold)
{
    if (!tarea)
        return;
 ...
 */
export void lower_economy(AREA_DATA* tarea, int gold)
{
    while (gold >= 1000000000)
    {
 ...
 */
export bool economy_has(AREA_DATA* tarea, int gold)
{
 ...
 */
export void add_kill(CHAR_DATA* ch, CHAR_DATA* mob)
{
    int x;
    sh_int track;
    int vnum;
 ...
 */
export int times_killed(CHAR_DATA* ch, CHAR_DATA* mob)
{
    int x;
    sh_int track;
    int vnum;
...
export int count_users(OBJ_DATA* obj)
{
    CHAR_DATA* fch;
    int count = 0;
...
export int max_weight(OBJ_DATA* obj)
{
    CHAR_DATA* fch;
    int weight = 0;
