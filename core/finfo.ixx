...
export void write_all_forcehelps()
{
    FORCE_HELP* fhelp;
    for (fhelp = first_force_help; fhelp; fhelp = fhelp->next)
...
export void save_forcehelp(FORCE_HELP* fhelp)
{
    FILE* fp;
    char filename[256];
...
export DO_FUN* get_force_skill_function(char* name)
{
...
export void write_all_forceskills()
{
    FORCE_SKILL* fskill;
    for (fskill = first_force_skill; fskill; fskill = fskill->next)
...
export void save_forceskill(FORCE_SKILL* fskill)
{
    FILE* fp;
    char filename[256];
