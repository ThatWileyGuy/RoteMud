...
export ch_ret one_hit(CHAR_DATA* ch, CHAR_DATA* victim, int dt);
 ...
 */
export bool is_hunting(CHAR_DATA* ch, CHAR_DATA* victim)
{
...
export bool is_hating(CHAR_DATA* ch, CHAR_DATA* victim)
{
...
export bool is_fearing(CHAR_DATA* ch, CHAR_DATA* victim)
{
...
export void stop_hunting(CHAR_DATA* ch)
{
    if (ch->hunting)
    {
...
export void stop_hating(CHAR_DATA* ch)
{
    if (ch->hating)
    {
...
export void stop_fearing(CHAR_DATA* ch)
{
    if (ch->fearing)
    {
...
export void start_hunting(CHAR_DATA* ch, CHAR_DATA* victim)
{
    if (ch->hunting)
        stop_hunting(ch);
...
export void start_hating(CHAR_DATA* ch, CHAR_DATA* victim)
{
    if (ch->hating)
        stop_hating(ch);
...
export void start_fearing(CHAR_DATA* ch, CHAR_DATA* victim)
{
    if (ch->fearing)
        stop_fearing(ch);
 ...
 * worry.
 */
export void violence_update(void)
{
 ...
 */
export ch_ret multi_hit(CHAR_DATA* ch, CHAR_DATA* victim, int dt)
{
    int chance;
    int dual_bonus;
    int extrahits;
 ...
 *					-Thoric
 */
export sh_int ris_damage(CHAR_DATA* ch, sh_int dam, int ris)
{
    sh_int modifier;
 ...
 */
export ch_ret damage(CHAR_DATA* ch, CHAR_DATA* victim, int dam, int dt)
{
    CHAR_DATA* gch;
...
export bool is_safe(CHAR_DATA* ch, CHAR_DATA* victim)
{
    if (!victim)
        return false;
 ...
 */
export bool legal_loot(CHAR_DATA* ch, CHAR_DATA* victim)
{
 ...
 */
export void update_pos(CHAR_DATA* victim)
{
    if (!victim)
    {
 ...
 * Start fights.
 */
export void set_fighting(CHAR_DATA* ch, CHAR_DATA* victim)
{
    FIGHT_DATA* fight;
...
export CHAR_DATA* who_fighting(CHAR_DATA* ch)
{
    if (!ch)
    {
...
export void free_fight(CHAR_DATA* ch)
{
    if (!ch)
    {
 ...
 * Stop fights.
 */
export void stop_fighting(CHAR_DATA* ch, bool fBoth)
{
    CHAR_DATA* fch;
...
export void death_cry(CHAR_DATA* ch)
{

    return;
}

export void raw_kill(CHAR_DATA* ch, CHAR_DATA* victim)
{
 ...
 */
export int xp_compute(CHAR_DATA* gch, CHAR_DATA* victim)
{
    int align;
    int xp;
...
export bool in_arena(CHAR_DATA* ch)
{
