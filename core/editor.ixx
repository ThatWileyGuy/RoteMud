...
EDITOR_DATA* str_to_editdata(const char* str, sh_int max_size);
char* editdata_to_str(EDITOR_DATA* edd);

/* simple functions to set a description for what's currently
 * being edited */
export void set_editor_desc(CHAR_DATA* ch, const char* new_desc);
export void editor_desc_printf(CHAR_DATA* ch, const char* desc_fmt, ...);

/* the main editor functions visible to the rest of the code */
export void start_editing_nolimit(CHAR_DATA* ch, char* old_text, sh_int max_total);
export char* copy_buffer(CHAR_DATA* ch);
export void stop_editing(CHAR_DATA* ch);
/* main editing function */
export void edit_buffer(CHAR_DATA* ch, char* argument);
