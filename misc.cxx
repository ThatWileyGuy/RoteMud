...
void do_droptroops(CHAR_DATA* ch, char* argument) {
	...
	sprintf_s(tmpbuf, "&RYelling and the thunder of feet is heard from the troop hold as %d troops exit the ship and fan out.\n\r", num);
...
void do_debitorder(CHAR_DATA* ch, char* argument)
{
	...
	else if (!strcmp(argument, "yes"))
	{
		...
		{
			send_to_char("The bank believes that it would be unreasonable for you to purchase a debit card at this time!\n\r", ch);
			return;
		}
