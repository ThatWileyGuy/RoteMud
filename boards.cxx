...
void do_note(CHAR_DATA* ch, const char* arg_passed, bool IS_MAIL)
{
	...
	if (!str_cmp(arg, "to"))
	{
		...
		sprintf_s(fname, "%s%c/%s", PLAYER_DIR, tolower(arg_passed[0]),
